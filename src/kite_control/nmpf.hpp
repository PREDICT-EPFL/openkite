...
public:
    ...
    casadi::Function getPathFunction(){return PathFunction;}
...
void nmpf<System, Path, NX, NU, NumSegments, PolyOrder>::createNLP(const casadi::Dict &solver_options)
{
    ...
    /** @todo : create a path function? */
    casadi::SX parameter = casadi::SX::sym("parameter");
    casadi::SX PathSymbolic = PathFunc(casadi::SXVector{parameter})[0];
    PathFunction = casadi::Function("PathFunction",{parameter},{PathSymbolic});
