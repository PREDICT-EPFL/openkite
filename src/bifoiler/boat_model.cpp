...
void BoatDynamics::Hydrodynamics(const SX &state, const SX &control, const SX &params, const BoatProperties &prop, SX &Fhbrf, SX &Mhbrf, SX &aoa, SX &ssa)
{
    ...
    */
    ...
    SX Cn0     = params(6); //    = prop.hydrodynamic.Cn0;
    SX Cnb     = params(7); //    = prop.hydrodynamic.Cnb;
    SX Cl0     = params(8); //    = prop.hydrodynamic.Cl0;
    SX Clb     = params(9); //    = prop.hydrodynamic.Clb;
    SX CLq     = params(10); //    = prop.hydrodynamic.CLq;
    SX Cmq     = params(11); //    = prop.hydrodynamic.Cmq;
    SX CYr     = params(12); //    = prop.hydrodynamic.CYr;
    SX Cnr     = params(13); //    = prop.hydrodynamic.Cnr;
    SX Clr     = params(14); //     = prop.hydrodynamic.Clr;
    SX CYp     = params(15); //    = prop.hydrodynamic.CYp;
    SX Clp     = params(16); //    = prop.hydrodynamic.Clp;
    SX Cnp     = params(17); //    = prop.hydrodynamic.Cnp;

    // Control Derivatives
    SX CXdf    = params(18); //       = prop.hydrodynamic.CXdf;
    SX CYdr    = params(19); //    = prop.hydrodynamic.CYdr;
    SX CZdf    = params(20); //    = prop.hydrodynamic.CZdf;
    SX Clda    = params(21); //    = prop.hydrodynamic.CLda;
    SX Cldr    = params(22); //    = prop.hydrodynamic.CLdr;
    SX Cmdf    = params(23); //    = prop.hydrodynamic.CMdf;
    SX Cnda    = params(24); //    = prop.hydrodynamic.CNda;
    SX Cndr    = params(25); //    = prop.hydrodynamic.CNdr;
...
BoatDynamics::BoatDynamics(const BoatProperties &prop)
{
    ...
    SX Cn0     = SX::sym("Cn0"); //    = prop.hydrodynamic.Cn0;
    SX Cnb     = SX::sym("Cnb"); //    = prop.hydrodynamic.Cnb;
    SX Cl0     = SX::sym("Cl0"); //    = prop.hydrodynamic.Cl0;
    ...
    SX params   = SX::vertcat({CL0, CLa_tot, CD0_tot, CYb, Cm0, Cma, Cn0, Cnb, Cl0, Clb, CLq, Cmq, CYr, Cnr,
